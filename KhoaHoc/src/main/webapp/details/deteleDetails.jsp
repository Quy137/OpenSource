...
<div class="viewport">
		...
		<div class="container-fluid">
		  <section class="container">
		    ...
		    <form class="row g-3" action="${pageContext.request.contextPath}/deleteDetailsServlet" method="get">
		      <div class="col-md-12">
		        <label for="id" class="form-label">Mã ID</label>
		        <input type="text" class="form-control" value="${param.code}" name="id" readonly>
		      </div>
		      <div class="col-md-12">
		        <label for="image" class="form-label">Hình Ảnh</label>
		        <input type="file" value="${param.hinhanh}" class="form-control" name="image" accept="image/*"  readonly>
		      </div>
		       <div class="col-md-12">
		        <label for="rating" class="form-label">Đánh Giá</label>
		        </label> <label><input type="radio" name="rating" value="${param.danhgia}"
								readonly class="form-control" id="rating"> 1 sao</label> <label><input
								type="radio" name="rating" value="${param.danhgia}" readonly
