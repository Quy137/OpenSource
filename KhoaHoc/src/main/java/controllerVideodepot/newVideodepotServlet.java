...
@WebServlet("/newVideodepotServlet")
public class newVideodepotServlet extends HttpServlet  {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect(request.getContextPath() + "/videodepot/addVideodepot.jsp");
	}
